...
\definecolor{electricblue}{RGB}{66,139,202}
\definecolor{royalblue}{RGB}{71,57,146}
\usepackage[colorlinks=true, citecolor=gray, linkcolor=royalblue,
    urlcolor=electricblue, pdfborder={0 0 0}]{hyperref}

\usepackage{fourier}
\usepackage[scale=.9]{sourcesanspro}
...
% Enable hyphenation on `tt` text to have word-break; this allows
% us to disable the `/sloppy` hack
%
% https://groups.google.com/forum/#!topic/comp.text.tex/_M1ByBy6CYo
\makeatletter
...
\definecolor{lightgray}{RGB}{253,253,253}

\lstset{basicstyle=\tt, stepnumber=1, frame=tblr,
backgroundcolor=\color{lightgray}, escapeinside={(*}{*)}}

% Make sure all of the TOC (incl. Chapter headings) are in
% serif font.
%
% http://amyrhoda.wordpress.com/2012/05/30/latex-to-lulu-
% the-making-of-aosa-table-of-contents-and-chapter-titles/
%\usepackage{tocloft}
...
among other free and open-source programs.
...
The most common constraint is mutual exclusion, or {\bf mutex},
